...
namespace BNJMO
{
    public class NetcodeMultiplayerHandler : AbstractMultiplayerHandler
    {
        ...
        public override async void JoinPrivateLobby(string lobbyCode)
        {
            ...
            try
            {
                ...
                if (lobby == null)
                {
                    OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.JoinLobbyByCode);
                    return;
                }
                
                joinedLobby = lobby;
                StateMachine.UpdateState(EMultiplayerState.InLobby);
            }
        ...
        public override async void QuickMatch()
        {
            ...
            try
            {
                ...
                if (publicLobbies.Count > 0)
                {
                    ...
                    if (joinedLobby == null)
                    {
                        OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.JoinLobbyByQuickMatch);
                    }
        ...
        {
            yield return new WaitForSeconds(bConfig.JoinMultiplayerTimeout);

            switch (StateMachine.CurrentState)
            {
                case EMultiplayerState.NotConnected:
                    OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.JoinLobbyTimeout);
                    break;
                
                case EMultiplayerState.InLobby:
                    OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.JoinMultiplayerTimeout);
                    break;
            }
        }
        ...
        private async void UpdateLobby()
        {
            ...
            catch (LobbyServiceException e)
            {
                ...
                {
                    ShutdownLobbyAndMultiplayer(ELeaveMultiplayerReason.HostLeft);
                }
            }
        }
        ...
        private async void CreateLobby(bool isPrivate = false)
        {
            ...
            try
            {
                ...
                if (lobby == null)
                {
                    OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.CreateLobby);
                    return;
                }
        ...
        private async void StartParty()
        {
            ...
            try
            {
                ...
                {
                    OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.StartMultiplayer);
                    return;
                }
        ...
        public async Task<string> CreateRelay()
        {
            try
            {
                ...
                if (allocation == null)
                {
                    OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.CreateRelay);
                    return null;
                }
        ...
        public async void JoinRelay(string joinCode)
        {
            try
            {
                ...
                {
                    OnJoinMultiplayerFailure(EJoinMultiplayerFailureType.JoinRelay);
                    return;
                }
        ...
        /* Failure */
        private void OnJoinMultiplayerFailure(EJoinMultiplayerFailureType joinMultiplayerFailureType)
        {
